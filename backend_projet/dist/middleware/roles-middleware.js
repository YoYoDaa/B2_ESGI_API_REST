...
exports.isConcernedByStudentCourse = exports.isCourseManager = exports.isEducationManager = exports.isAdmin = exports.isRolesPOSTModel = void 0;
...
const isAdmin = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield hasTheRights(authHeader, ['ADMINISTRATEUR'])
            .then((isRightRole) => {
            if (isRightRole) {
                next();
            }
...
const isEducationManager = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield hasTheRights(authHeader, [
            roles_model_1.isRightRoleEnum.ADMINISTRATEUR,
...
const isCourseManager = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const authHeader = req.get('Authorization');
        yield hasTheRights(authHeader, [
            roles_model_1.isRightRoleEnum.ADMINISTRATEUR,
            ...
            roles_model_1.isRightRoleEnum.REPROGRAPHE,
            roles_model_1.isRightRoleEnum.RESPONSABLE_PEDA,
            roles_model_1.isRightRoleEnum.INTERVENANT,
        ])
            .then((isRightRole) => {
            if (isRightRole) {
                next();
...
const isConcernedByStudentCourse = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const authHeader = req.get('Authorization');
        yield hasTheRights(authHeader, [
            roles_model_1.isRightRoleEnum.ADMINISTRATEUR,
            ...
            roles_model_1.isRightRoleEnum.RESPONSABLE_PEDA,
            roles_model_1.isRightRoleEnum.INTERVENANT,
            roles_model_1.isRightRoleEnum.ETUDIANT,
        ])
            .then((isRightRole) => {
            if (isRightRole) {
                next();
...
exports.isConcernedByStudentCourse = isConcernedByStudentCourse;
